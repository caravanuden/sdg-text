...
class _model(nn.Module):
    ...
    def forward(self, x__1):
        ...
        __ListConstruct27 = [__final_layer_1, __final_layer_2, __final_layer_3, __final_layer_4]
        __input_choice = self.__input_choice(__ListConstruct27)
        __aten__select28 = __input_choice.select(dim=__Constant1, index=__Constant1)
        return __aten__select28