...
class _model__fc1(nn.Module):
    def __init__(self):
        super().__init__()
        self.__0 = torch.nn.modules.linear.Linear(in_features=100, out_features=300)
...
class _model__final_layer_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.__0 = torch.nn.modules.linear.Linear(in_features=1, out_features=100)
...
class _model__fc2(nn.Module):
    def __init__(self):
        super().__init__()
        self.__0 = torch.nn.modules.linear.Linear(in_features=0, out_features=100)
...
class _model__final_layer_2(nn.Module):
    def __init__(self):
        super().__init__()
        self.__0 = torch.nn.modules.linear.Linear(in_features=1, out_features=0)
        self.__1 = torch.nn.modules.activation.Sigmoid()
...
class _model__fc3(nn.Module):
    def __init__(self):
        super().__init__()
        self.__0 = torch.nn.modules.linear.Linear(in_features=250, out_features=0)
...
class _model__final_layer_3(nn.Module):
    def __init__(self):
        super().__init__()
        self.__0 = torch.nn.modules.linear.Linear(in_features=1, out_features=250)
        self.__1 = torch.nn.modules.activation.Sigmoid()
...
class _model__fc4__1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice__mutation_9_3 = torch.nn.modules.activation.Tanh()

    def forward(self, *_inputs):
        layerchoice__mutation_9_3 = self.layerchoice__mutation_9_3(_inputs[0])
        return layerchoice__mutation_9_3
...
class _model__fc4(nn.Module):
    def __init__(self):
        super().__init__()
        self.__0 = torch.nn.modules.linear.Linear(in_features=300, out_features=250)
...
class _model__final_layer_4(nn.Module):
    def __init__(self):
        super().__init__()
        self.__0 = torch.nn.modules.linear.Linear(in_features=1, out_features=300)
        self.__1 = torch.nn.modules.activation.Sigmoid()
...
class _model(nn.Module):
    def __init__(self):
        ...
        self.__input_choice = nni.retiarii.nn.pytorch.ChosenInputs(chosen=[0], reduction='none')
